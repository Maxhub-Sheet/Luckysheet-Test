        ...
        $("#luckysheet-icon-cell-color-menu").click(function(){
            ...
            if($menuButton.length == 0){
                ...
                $("#" + menuButtonId).find(".luckysheet-color-selected").spectrum({
                    ...
                    palette: [
                        ['#ffffff','#000000','#FF3B30','#FF9500','#FADB14','#4CD964','#5AC8FA','#007AFF','#732ED1','#EB2E95'],
                        ['#E9E9E9','#808080','#FCDEE2','#FCE5DB','#FEF1D6','#D8F4E5','#D5EFF5','#DAE9FE','#E5E6FC','#FAE1EB'],
                        ['#D9D9D9','#666666','#F9BDC4','#F9CAB8','#FDE4AE','#B1E9CB','#D5EFF5','#B6D2FE','#CBCDF9','#FFADD1'],
                        ['#C4C4C4','#4D4D4D','#C25463','#C1704C','#C99C3A','#40A46D','#3894A7','#487DCB','#6E71C0','#CD679C'],
                        ['#9D9D9D','#000000','#903F4A','#915439','#97752A','#307B52','#296F7E','#365E98','#525590','#9E477F'],
